...
public class SinaRefreshView extends FrameLayout implements IHeaderView {
    ...
    private String pullDownStr = getContext().getResources().getString(R.string.pull_to_refresh);
    private String releaseRefreshStr = getContext().getResources().getString(R.string.release_refresh);
    private String refreshingStr = getContext().getResources().getString(R.string.refreshing);
