...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public static String REFRESH_HEADER_ALLLOADED = "全部刷新完成";
    ...
    private void initHint() {
        ...
        REFRESH_HEADER_PULLDOWN = context.getString(com.scwang.smartrefresh.layout.R.string.srl_pull_down_to_refresh);
        REFRESH_HEADER_REFRESHING = context.getString(com.scwang.smartrefresh.layout.R.string.srl_refreshing);
        REFRESH_HEADER_LOADING = context.getString(com.scwang.smartrefresh.layout.R.string.srl_loading);
        REFRESH_HEADER_RELEASE = context.getString(com.scwang.smartrefresh.layout.R.string.srl_release_to_refresh);
        REFRESH_HEADER_FINISH = context.getString(com.scwang.smartrefresh.layout.R.string.srl_refreshing_completed);
        REFRESH_HEADER_FAILED = context.getString(com.scwang.smartrefresh.layout.R.string.srl_fail_to_refresh);
        REFRESH_HEADER_ALLLOADED = context.getString(com.scwang.smartrefresh.layout.R.string.srl_full_refreshed);
    }
    ...
    public boolean setRefreshFinished(boolean finished) {
        if (mRefreshFinished != finished) {
            ...
            if (finished) {
                mTitleText.setText(REFRESH_HEADER_ALLLOADED);
            } else {
                mTitleText.setText(REFRESH_HEADER_PULLDOWN);
            }
            if (mProgressDrawable != null) {
