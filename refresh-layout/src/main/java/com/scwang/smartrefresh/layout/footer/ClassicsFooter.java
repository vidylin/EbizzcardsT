...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    private void initHint() {
        ...
        REFRESH_FOOTER_PULLUP = context.getString(com.scwang.smartrefresh.layout.R.string.srl_pull_up_to_loadmore);
        REFRESH_FOOTER_RELEASE = context.getString(com.scwang.smartrefresh.layout.R.string.srl_release_to_load);
        REFRESH_FOOTER_LOADING = context.getString(com.scwang.smartrefresh.layout.R.string.srl_loading);
        REFRESH_FOOTER_REFRESHING = context.getString(com.scwang.smartrefresh.layout.R.string.srl_refreshing);
        REFRESH_FOOTER_FINISH = context.getString(com.scwang.smartrefresh.layout.R.string.srl_loading_completed);
        REFRESH_FOOTER_FAILED = context.getString(com.scwang.smartrefresh.layout.R.string.srl_fail_to_load);
        REFRESH_FOOTER_ALLLOADED = context.getString(com.scwang.smartrefresh.layout.R.string.srl_full_loaded);
    }
