...
class DatabaseMessageStore implements MessageStore {
    ...
    private static class MQTTDatabaseHelper extends SQLiteOpenHelper {
         ...
         * Constructor.
         *
         * @param traceHandler MqttTraceHandler
         * @param context      Context
         */
        MQTTDatabaseHelper(MqttTraceHandler traceHandler, Context context) {
        ...
        public void onCreate(SQLiteDatabase database) {
            String createArrivedTableStatement =
                    "CREATE TABLE " + ARRIVED_MESSAGE_TABLE_NAME
                            + "("
                            ...
                            + MqttServiceConstants.DUPLICATE + " TEXT, "
                            + MTIMESTAMP + " INTEGER"
                            + ");";
     ...
     */
    DatabaseMessageStore(MqttService service, Context context) {
