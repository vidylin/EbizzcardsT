...
/**
 * <p>Implementation of the IMqttToken interface for use from within the MqttAndroidClient implementation.
 */
...
class MqttTokenAndroid implements IMqttToken {
    ...
    private final Object waitObject = new Object();// lock
     ...
     * @param listener    optional listener that will be notified when the action completes.
