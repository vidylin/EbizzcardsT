...
public class MqttAndroidClient extends BroadcastReceiver implements IMqttAsyncClient {
    ...
    public enum Ack {
        /**
         * As soon as the {@link MqttCallback#messageArrived(String, MqttMessage)} returns, the message
         * has been acknowledged as received .
         */
        AUTO_ACK,
        /**
         * When {@link MqttCallback#messageArrived(String, MqttMessage)} returns, the message will not be
         * acknowledged as received,
         * the application will have to make an acknowledgment call to {@link MqttAndroidClient} using
         * {@link MqttAndroidClient#acknowledgeMessage(String)}
         */
        MANUAL_ACK
    }

    private static final String SERVICE_NAME = MqttService.class.getCanonicalName();
    ...
    public void close() {
        if (mqttService != null) {
            if (clientHandle == null) {
                clientHandle = mqttService.getClient(serverURI, clientId, mContext.getApplicationInfo().packageName, persistence);
            }
     ...
     * </p>
     *
     * @return token used to track and wait for the connect to complete. The token will be
     * passed to the callback methods if a callback is set.
     ...
     * @return token used to track and wait for the connect to complete. The token will be
     * passed to any callback that has been set.
     * @throws MqttException for any connected problems
     * @see #connect(MqttConnectOptions, Object, IMqttActionListener)
     */
    @Override
     ...
     * @param callback    optional listener that will be notified when the connect completes.
     *                    Use null if not required.
     * @return token used to track and wait for the connect to complete. The token will be
     * passed to any callback that has been set.
     * @throws MqttException for any connected problems
     ...
     *
     * @param options     a set of connection parameters that override the defaults.
     * @param userContext optional object for used to pass context to the callback.
     *                    Use null if not required.
     * @param callback    optional listener that will be notified when the connect completes.
     *                    Use null if not required.
     * @return token used to track and wait for the connect to complete. The token will be
     ...
     * </p>
     *
     * @return token used to track and wait for disconnect to complete. The token will be
     * passed to any callback that has been set.
     ...
     * </p>
     *
     * @param quiesceTimeout the amount of time in milliseconds to allow for existing work to
     ...
     * @param userContext optional object used to pass context to the callback.
     *                    Use null if not required.
     * @param callback    optional listener that will be notified when the disconnect completes.
     *                    Use null if not required.
     * @return token used to track and wait for the disconnect to complete. The token will be
     * passed to any callback that has been set.
     * @throws MqttException for problems encountered while disconnecting
     * @see #disconnect(long, Object, IMqttActionListener)
     */
     ...
     * </ul>
     * <p>The method returns control before the publish completes. Completion can be tracked by:</p>
     * <ul>
     ...
     * @return token used to track and wait for the subscribe to complete. The token will be
     * passed to callback methods if set.
     * @throws MqttException if there was an error registering the subscription.
     * @see #subscribe(String[], int[], Object, IMqttActionListener)
     */
    @Override
     ...
     * @return token used to track and wait for the unsubscribe to complete. The token will be
     * passed to callback methods if set.
     ...
     * @return token used to track and wait for the unsubscribe to complete. The token will
     * be passed to callback methods if set.
     * @throws MqttException if there was an error unregistering the subscription.
     * @see #unsubscribe(String[], Object, IMqttActionListener)
     */
    @Override
     ...
     * </p>
     * <p>
     * <strong>Note:</strong> This is only a public method because the Android APIs require such.
     * <br>
