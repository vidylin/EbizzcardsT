 ...
 * <li>
 * To recover messages which have not been definitely passed to the consumer,
 * {@link MessageStore#getAllArrivedMessages(String)} is used.
 * <li>When a clean session is started {@link #clearArrivedMessages(String)} is used.
 * </ul>
 */
