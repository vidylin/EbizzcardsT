 ...
 * <ol>
 * <li>
 * <b>isSupportedOnJVM()</b>: to check whether this class is supported on
 * the runtime platform. Not all runtimes support SSL/TLS.
 * </li>
 * <li>
 * <b>SSLSocketFactoryFactory()</b>: the constructor. Clients
 * (in the same JVM) may share an SSLSocketFactoryFactory, or have one each.
 * </li>
 * <li>
 * <b>initialize(properties, configID)</b>: to initialize this object with
 ...
 * </li>
 * <li>
 * <b>getEnabledCipherSuites(configID)</b>: to later set the enabled
 ...
 * <ol>
 * <li>
 * <b>getKeyStore(configID)</b>: Optionally, to check that if there is no
 ...
 * <li>
 * <b>getClientAuthentication(configID)</b>: to later set on the
...
public class SSLSocketFactoryFactory {
    ...
    public static String obfuscate(char[] password) {
        ...
        return xorTag + SimpleBase64Encoder.encode(bytes);// String encryptedValue = ;
    }

    /**
     * The inverse operation of obfuscate: returns a cleartext password that was previously
     * obfuscated using the XOR scrambler.
     *
...
//    }
     ...
     *
     * @param props    A properties object containing IBM SSL properties that are qualified by
     *                 one or more configuration identifiers.
     * @param configID The configuration identifier for selecting a configuration or
     *                 null for the default configuration.
     * @throws IllegalArgumentException if any of the properties is not a valid IBM SSL property key.
     */
     ...
     *
     * @param configID The configuration identifier for selecting a configuration or null for the default configuration.
...
//    }
     ...
     * @param ibmKey   String
     * @return the property of a given key or null if it doesn't exist.
     * It first scans the indicated configuration, then the default configuration.
     */
    private String getPropertyFromConfig(String configID, String ibmKey) {
        String res;
        Properties p = null;
        if (configID != null) {
            p = configs.get(configID);
        }
        if (p != null) {
...
//        }
    ...
    public String[] getEnabledCipherSuites(String configID) {
        ...
        return unpackCipherSuites(ciphers);// res
    }
    ...
    private SSLContext getSSLContext(String configID) throws MqttSecurityException {
        ...
        if (logger != null) {
            ...
            logger.fine(CLASS_NAME, METHOD_NAME, "12000", new Object[]{configID != null ? configID : "null (broker defaults)", protocol});
        }
        ...
        try {
            ...
            if (logger != null) {
                ...
                logger.fine(CLASS_NAME, METHOD_NAME, "12001", new Object[]{configID != null ? configID : "null (broker defaults)", ctx.getProvider().getName()});
            }
...
//            }
            ...
            if (keyStore == null) {
                ...
                if (logger != null) {
                    ...
                    logger.fine(CLASS_NAME, METHOD_NAME, "12004", new Object[]{configID != null ? configID : "null (broker defaults)", keyStoreName != null ? keyStoreName : "null"});
                }

                char[] keyStorePwd = getKeyStorePassword(configID);
                if (logger != null) {
                    // 12005 "SSL initialization: configID = {0}, keystore password = {1}"
                    logger.fine(CLASS_NAME, METHOD_NAME, "12005", new Object[]{configID != null ? configID : "null (broker defaults)", keyStorePwd != null ? obfuscate(keyStorePwd) : "null"});
                }
                ...
                if (logger != null) {
                    ...
                    logger.fine(CLASS_NAME, METHOD_NAME, "12006", new Object[]{configID != null ? configID : "null (broker defaults)", keyStoreType != null ? keyStoreType : "null"});
                }
                ...
                if (keyStoreName != null && keyStoreType != null && keyMgrAlgo != null) {
                    try {
                        ...
                        if (logger != null) {
                            ...
                            logger.fine(CLASS_NAME, METHOD_NAME, "12010", new Object[]{configID != null ? configID : "null (broker defaults)", keyMgrAlgo != null ? keyMgrAlgo : "null"});
                            // 12009 "SSL initialization: configID = {0}, keystore manager provider = {1}"
                            logger.fine(CLASS_NAME, METHOD_NAME, "12009", new Object[]{configID != null ? configID : "null (broker defaults)", keyMgrFact.getProvider().getName()});
                        }
            ...
            if (logger != null) {
                ...
                logger.fine(CLASS_NAME, METHOD_NAME, "12011", new Object[]{configID != null ? configID : "null (broker defaults)", trustStoreName != null ? trustStoreName : "null"});
            }
            KeyStore trustStore;
            ...
            if (logger != null) {
                ...
                logger.fine(CLASS_NAME, METHOD_NAME, "12012", new Object[]{configID != null ? configID : "null (broker defaults)", trustStorePwd != null ? obfuscate(trustStorePwd) : "null"});
            }
            ...
            if (logger != null) {
                ...
                logger.fine(CLASS_NAME, METHOD_NAME, "12013", new Object[]{configID != null ? configID : "null (broker defaults)", trustStoreType != null ? trustStoreType : "null"});
            }
            ...
            if (trustStoreName != null && trustStoreType != null && trustMgrAlgo != null) {
                try {
                    ...
                    if (logger != null) {
                        ...
                        logger.fine(CLASS_NAME, METHOD_NAME, "12017", new Object[]{configID != null ? configID : "null (broker defaults)", trustMgrAlgo != null ? trustMgrAlgo : "null"});
...
//    }
    ...
    public SSLSocketFactory createSocketFactory(String configID) throws MqttSecurityException {
        ...
        if (logger != null) {
            ...
            logger.fine(CLASS_NAME, METHOD_NAME, "12020", new Object[]{
                    configID != null ? configID : "null (broker defaults)",
                    getEnabledCipherSuites(configID) != null ? getProperty(configID, CIPHERSUITES, null) : "null (using platform-enabled cipher suites)"
            });
        }
