...
public class CommsTokenStore {
    ...
    public MqttDeliveryToken[] getOutstandingDelTokens() {
        ...
        synchronized (tokens) {
            ...
            Vector<MqttDeliveryToken> list = new Vector<>();
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if (token != null
                    ...
                    list.addElement((MqttDeliveryToken) token);
                }
            }
    ...
    public Vector<MqttToken> getOutstandingTokens() {
        ...
        synchronized (tokens) {
            ...
            Vector<MqttToken> list = new Vector<>();
    ...
    public void clear() {
        ...
        //@TRACE 305=> {0} tokens
        log.fine(CLASS_NAME, methodName, "305", new Object[]{tokens.size()});
        synchronized (tokens) {
            tokens.clear();
        }
    }
