 ...
 * Once initialised a call to dumpClientDebug will force any memory trace together with pertinent client and system state to the main log facility.
 * <p>
 * No client wide lock is taken when the dump is progress.
 * This means the set of client state may not be consistent as the client can still be processing work while the dump is in progress.
 */
public class Debug {
    ...
    protected void dumpVersion() {
        String vInfo = lineSep + separator + " Version Info " + separator + lineSep +
                left("Version", 20, ' ') + ":  " + ClientComms.VERSION + lineSep +
                left("Build Level", 20, ' ') + ":  " + ClientComms.BUILD_LEVEL + lineSep +
                separator + separator + separator + lineSep;
        log.fine(CLASS_NAME, "dumpVersion", vInfo);
    }
    ...
    public void dumpSystemProperties() {
        ...
        log.fine(CLASS_NAME, "dumpSystemProperties", dumpProperties(sysProps, "SystemProperties"));
    }
    ...
    public void dumpClientState() {
        ...
        if (comms != null && comms.getClientState() != null) {
            ...
            log.fine(CLASS_NAME, "dumpClientState", dumpProperties(props, clientID + " : ClientState"));
        }
    }
    ...
    public void dumpClientComms() {
        ...
        if (comms != null) {
            ...
            log.fine(CLASS_NAME, "dumpClientComms", dumpProperties(props, clientID + " : ClientComms"));
        }
    }
    ...
    public void dumpConOptions() {
        ...
        if (comms != null) {
            ...
            log.fine(CLASS_NAME, "dumpConOptions", dumpProperties(props, clientID + " : Connect Options"));
        }
    }
