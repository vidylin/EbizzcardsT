...
/**
 * Extension of {@link MqttCallback} to allow new callbacks without breaking the API for existing applications.
 * Classes implementing this interface can be registered on both types of client:
 * {@link IMqttClient#setCallback(MqttCallback)} and {@link IMqttAsyncClient#setCallback(MqttCallback)}
 */
