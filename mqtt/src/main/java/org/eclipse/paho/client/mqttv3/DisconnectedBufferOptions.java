...
public class DisconnectedBufferOptions {
    ...
    private static final int DISCONNECTED_BUFFER_SIZE_DEFAULT = 5000;

    private static final boolean DISCONNECTED_BUFFER_ENABLED_DEFAULT = false;

    private static final boolean PERSIST_DISCONNECTED_BUFFER_DEFAULT = false;

    private static final boolean DELETE_OLDEST_MESSAGES_DEFAULT = false;
