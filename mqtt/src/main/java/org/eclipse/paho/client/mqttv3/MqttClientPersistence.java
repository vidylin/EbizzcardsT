...
public interface MqttClientPersistence {
     ...
     * @throws MqttPersistenceException if there was a problem putting the data into the persistent store.
     */
     ...
     * @throws MqttPersistenceException if there was a problem getting the data from the persistent store.
     */
