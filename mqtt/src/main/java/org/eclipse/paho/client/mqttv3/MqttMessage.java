...
/**
 * An MQTT message holds the application payload and options specifying how the message is to be delivered.
 * The message includes a "payload" (the body of the message) represented as a byte[].
 */
...
public class MqttMessage {
     ...
     *
     * @param mutable <code>true</code> if the values can be changed, <code>false</code> to prevent them from being changed.
     */
     ...
     * Has no effect when publishing messages.
     *
     * @param messageId int
     */
    ...
    /**
     * Returns the MQTT id of the message. This is only applicable to messages received from the server.
     *
