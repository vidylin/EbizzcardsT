...
public class Token {
    ...
    public void waitForCompletion(long timeout) throws MqttException {
        ...
        log.fine(CLASS_NAME, methodName, "407", new Object[]{getKey(), timeout, this});
    ...
    protected MqttWireMessage waitForResponse(long timeout) throws MqttException {
        ...
        synchronized (responseLock) {
            ...
            log.fine(CLASS_NAME, methodName, "400", new Object[]{getKey(), timeout, sent, completed, (exception == null) ? "false" : "true", response, this}, exception);

            while (!completed) {
                if (exception == null) {
                    try {
                        //@TRACE 408=key={0} wait max={1}
                        log.fine(CLASS_NAME, methodName, "408", new Object[]{getKey(), timeout});
        ...
        log.fine(CLASS_NAME, methodName, "402", new Object[]{getKey(), response});
        return response;
    }
    ...
    protected void notifyComplete() {
        ...
        log.fine(CLASS_NAME, methodName, "404", new Object[]{getKey(), response, exception});
