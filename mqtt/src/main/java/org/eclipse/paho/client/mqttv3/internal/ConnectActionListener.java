...
public class ConnectActionListener implements IMqttActionListener {
     ...
     * @param comms        ClientComms
     * @param options      MqttConnectOptions
     * @param userToken    MqttToken
     * @param userContext  Object
     * @param userCallback IMqttActionListener
     */
    ...
    public void onFailure(IMqttToken token, Throwable exception) {
        ...
        if (
                (index + 1) < numberOfURIs ||
                        (
                                originalMqttVersion == MqttConnectOptions.MQTT_VERSION_DEFAULT
     ...
     *
     * @param mqttCallbackExtended MqttCallbackExtended
     */
