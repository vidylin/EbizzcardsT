...
public abstract class MqttWireMessage {
    ...
    public String getKey() {
        return String.valueOf(getMessageId());
    }
    ...
    public static MqttWireMessage createWireMessage(MqttPersistable data) throws MqttException {
        ...
        MultiByteArrayInputStream mbais =
     ...
     * @throws MqttException thrown when an error occurs with either reading from the stream or decoding the encoded string.
     */
