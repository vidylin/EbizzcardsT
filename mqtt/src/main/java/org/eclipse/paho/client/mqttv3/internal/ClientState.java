...
public class ClientState {
    ...
    private Hashtable<Integer, MqttWireMessage> outboundQoS2 = null;
    private Hashtable<Integer, MqttWireMessage> outboundQoS1 = null;
    private Hashtable<Integer, MqttWireMessage> outboundQoS0 = null;
    private Hashtable<Integer, MqttWireMessage> inboundQoS2 = null;
    ...
    private Vector<MqttWireMessage> reOrder(Vector<MqttWireMessage> list) {
        ...
        Vector<MqttWireMessage> newList = new Vector<>();
    ...
    protected void restoreState() throws MqttException {
        ...
        Vector<String> orphanedPubRels = new Vector<>();
        //@TRACE 600=>
        ...
        while (messageKeys.hasMoreElements()) {
            ...
            if (message != null) {
                if (key.startsWith(PERSISTENCE_RECEIVED_PREFIX)) {
                    ...
                    inboundQoS2.put(message.getMessageId(), message);
                    ...
                    if (persistence.containsKey(getSendConfirmPersistenceKey(sendMessage))) {
                        ...
                        if (confirmMessage != null) {
                            ...
                            outboundQoS2.put(confirmMessage.getMessageId(), confirmMessage);
                        } else {
                    ...
                    if (sendMessage.getMessage().getQos() == 2) {
                        ...
                        outboundQoS0.put(sendMessage.getMessageId(), sendMessage);
        ...
        if (message instanceof MqttPublish) {
            synchronized (queueLock) {
                if (actualInFlight >= this.maxInflight) {
                    ...
                    log.fine(CLASS_NAME, methodName, "613", new Object[]{actualInFlight});
                ...
                log.fine(CLASS_NAME, methodName, "628", new Object[]{message.getMessageId(), innerMessage.getQos(), message});

                switch (innerMessage.getQos()) {
                    case 2:
                        outboundQoS2.put(message.getMessageId(), message);
                        persistence.put(getSendPersistenceKey(message), (MqttPublish) message);
                        break;
                    case 1:
                        outboundQoS1.put(message.getMessageId(), message);
                        persistence.put(getSendPersistenceKey(message), (MqttPublish) message);
                        break;
                }
            ...
            log.fine(CLASS_NAME, methodName, "615", new Object[]{message.getMessageId(), message});
    ...
    protected void undo(MqttPublish message) throws MqttPersistenceException {
        ...
        synchronized (queueLock) {
            ...
            log.fine(CLASS_NAME, methodName, "618", new Object[]{message.getMessageId(), message.getMessage().getQos()});

            if (message.getMessage().getQos() == 1) {
                outboundQoS1.remove(message.getMessageId());
            } else {
                outboundQoS2.remove(message.getMessageId());
            }
        ...
        if (connected && this.keepAlive > 0) {
            ...
            synchronized (pingOutstandingLock) {
                ...
                if (pingOutstanding > 0 && (time - lastInboundActivity >= keepAlive + delta)) {
                    ...
                    log.severe(CLASS_NAME, methodName, "619", new Object[]{keepAlive, lastOutboundActivity, lastInboundActivity, time, lastPing});
                ...
                if (pingOutstanding == 0 && (time - lastOutboundActivity >= 2 * keepAlive)) {
                    ...
                    log.severe(CLASS_NAME, methodName, "642", new Object[]{keepAlive, lastOutboundActivity, lastInboundActivity, time, lastPing});
                ...
                if ((pingOutstanding == 0 && (time - lastInboundActivity >= keepAlive - delta))
                    ...
                    log.fine(CLASS_NAME, methodName, "620", new Object[]{keepAlive, lastOutboundActivity, lastInboundActivity});
     ...
     * - the keepAlive interval is exceeded, which triggers a ping message to be returned
     * - {@link #disconnected(MqttException)} is called
     *
    ...
    protected MqttWireMessage get() throws MqttException {
        ...
        synchronized (queueLock) {
            while (result == null) {
                ...
                if (!connected &&
                        (pendingFlows.isEmpty() || !(pendingFlows.elementAt(0) instanceof MqttConnect))) {
...
//                checkForActivity(); //Use pinger, don't check here
                ...
                if (!pendingFlows.isEmpty()) {
                    ...
                    result = pendingFlows.remove(0);
                    if (result instanceof MqttPubRel) {
                        inFlightPubRels++;

                        //@TRACE 617=+1 inflightpubrels={0}
                        log.fine(CLASS_NAME, methodName, "617", new Object[]{inFlightPubRels});
                    }
                    ...
                    if (actualInFlight < this.maxInflight) {
                        ...
                        log.fine(CLASS_NAME, methodName, "623", new Object[]{actualInFlight});
                    } else {
    ...
    public void notifySentBytes(int sentBytesCount) {
        ...
        log.fine(CLASS_NAME, methodName, "643", new Object[]{sentBytesCount});
    }
    ...
    protected void notifySent(MqttWireMessage message) {
        ...
        if (message instanceof MqttPingReq) {
            synchronized (pingOutstandingLock) {
                ...
                log.fine(CLASS_NAME, methodName, "635", new Object[]{pingOutstanding});
            }
    ...
    private void decrementInFlight() {
        ...
        synchronized (queueLock) {
            ...
            log.fine(CLASS_NAME, methodName, "646", new Object[]{actualInFlight});
...
//        if (quiescing && actualInFlight == 0 && pendingFlows.size() == 0 && inFlightPubRels == 0 && callback.isQuiesced()) {
        ...
        if (quiescing && tokC == 0 && pendingFlows.size() == 0 && callback.isQuiesced()) {
            ...
            log.fine(CLASS_NAME, methodName, "626", new Object[]{quiescing, actualInFlight, pendingFlows.size(), inFlightPubRels, callback.isQuiesced(), tokC});
            synchronized (quiesceLock) {
    ...
    public void notifyReceivedBytes(int receivedBytesCount) {
        ...
        log.fine(CLASS_NAME, methodName, "630", new Object[]{receivedBytesCount});
    }
    ...
    protected void notifyReceivedAck(MqttAck ack) throws MqttException {
        ...
        log.fine(CLASS_NAME, methodName, "627", new Object[]{ack.getMessageId(), ack});
        ...
        if (token == null) {
            ...
            log.fine(CLASS_NAME, methodName, "662", new Object[]{ack.getMessageId()});
            ...
            log.fine(CLASS_NAME, methodName, "636", new Object[]{pingOutstanding});
    ...
    protected void notifyReceivedMsg(MqttWireMessage message) throws MqttException {
        ...
        log.fine(CLASS_NAME, methodName, "651", new Object[]{message.getMessageId(), message});
            ...
            if (message instanceof MqttPublish) {
                ...
                switch (send.getMessage().getQos()) {
                    ...
                    case 2:
                        ...
                        inboundQoS2.put(send.getMessageId(), send);
                ...
                MqttPublish sendMsg = (MqttPublish) inboundQoS2.get(message.getMessageId());
                if (sendMsg != null) {
                    if (callback != null) {
    ...
    protected void notifyComplete(MqttToken token) throws MqttException {
        ...
        if (message != null && message instanceof MqttAck) {
            ...
            log.fine(CLASS_NAME, methodName, "629", new Object[]{message.getMessageId(), token, message});
            ...
            if (ack instanceof MqttPubAck) {
                ...
                persistence.remove(getSendPersistenceKey(message));
                outboundQoS1.remove(ack.getMessageId());
                decrementInFlight();
                releaseMessageId(message.getMessageId());
                tokenStore.removeToken(message);
                // @TRACE 650=removed Qos 1 publish. key={0}
                log.fine(CLASS_NAME, methodName, "650", new Object[]{ack.getMessageId()});
                ...
                outboundQoS2.remove(ack.getMessageId());
                ...
                log.fine(CLASS_NAME, methodName, "645", new Object[]{ack.getMessageId(), inFlightPubRels});
            }
    ...
    public Vector resolveOldTokens(MqttException reason) {
        ...
        while (outTE.hasMoreElements()) {
            MqttToken tok = outTE.nextElement();
            synchronized (tok) {
    ...
    public void quiesce(long timeout) {
        ...
        if (timeout > 0) {
            //@TRACE 637=timeout={0}
            log.fine(CLASS_NAME, methodName, "637", new Object[]{timeout});
            synchronized (queueLock) {
                this.quiescing = true;
            }
            ...
            synchronized (quiesceLock) {
                try {
                    ...
                    if (tokc > 0 || pendingFlows.size() > 0 || !callback.isQuiesced()) {
                        ...
                        log.fine(CLASS_NAME, methodName, "639", new Object[]{actualInFlight, pendingFlows.size(), inFlightPubRels, tokc});
    ...
    protected void deliveryComplete(MqttPublish message) throws MqttPersistenceException {
        ...
        log.fine(CLASS_NAME, methodName, "641", new Object[]{message.getMessageId()});

        persistence.remove(getReceivedPersistenceKey(message));
        inboundQoS2.remove(message.getMessageId());
    }
    ...
    protected void deliveryComplete(int messageId) throws MqttPersistenceException {
        ...
        //@TRACE 641=remove publish from persistence. key={0}
        log.fine(CLASS_NAME, methodName, "641", new Object[]{messageId});

        persistence.remove(getReceivedPersistenceKey(messageId));
        inboundQoS2.remove(messageId);
    }
