...
public interface IMqttClient { //extends IMqttAsyncClient {
     ...
     * </p>
     *
     * @throws MqttSecurityException when the server rejects the connect for security reasons.
     ...
     * @throws MqttException         for non security related problems including communication errors
     */
    IMqttToken connectWithResult(MqttConnectOptions options) throws MqttException;
     ...
     * Disconnects from the server.
     * <p>
     * The client will wait for all {@link MqttCallback} methods to complete.
     * It will then wait for up to the quiesce timeout to allow for
     ...
     * <li>The client connects with cleanSession set to true</ul></li>
     ...
     * <dd>
     * <p>The number sign (#) is a wildcard character that matches
     ...
     * <br />   finance/stock/ibm/closingprice
     * <br />   finance/stock/ibm/currentprice</pre>
     * </p>
     * <p>
     ...
     * @see #subscribe(String[], int[])
     */
    void subscribe(String topicFilter, IMqttMessageListener messageListener) throws MqttException;
     ...
     * @see #subscribe(String[], int[])
     */
    void subscribe(String[] topicFilters, IMqttMessageListener[] messageListeners) throws MqttException;
     ...
     *
     * @param topicFilter the topic to unsubscribe from. It must match a topicFilter specified on the subscribe.
     ...
     * <p>
     * Unsubscribing is the opposite of subscribing. When the server receives the
     ...
     * </p>
     *
     * @param topicFilters one or more topics to unsubscribe from. Each topicFilter must match one specified on a subscribe
     * @throws MqttException if there was an error unregistering the subscription.
     */
     ...
     * @throws MqttException            for other errors encountered while publishing the message. For instance client not connected.
     ...
     * as connect and subscribe can be tracked using the {@link MqttToken} passed to the operation.
     * <p>
     *
     ...
     * different from <em>finance</em>. <em>/finance</em> matches "+/+" and "/+", but not "+".</li>
     * <li>Do not include the null character (Unicode<samp class="codeph"> \x0000</samp>) in any topic.</li>
     * </ul>
     * <p>
     * <p>
     ...
     * For state to be remembered the client must connect with cleanSession set to false.
     * </P>
     *
    ...
    /**
     * Close the client.
     * Releases all resource associated with the client. After the client has been closed it cannot be reused.
