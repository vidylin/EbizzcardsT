...
public class WebSocketHandshake {
    ...
    private void receiveHandshakeResponse(String key) throws IOException {
        ...
        if (line == null) {
            throw new IOException("WebSocket Response header: Invalid response from Server, " +
                    "It may not support WebSockets.");
        }
     ...
     */
    private Map getHeaders(ArrayList<String> headers) {
     ...
     * @throws HandshakeFailedException HandshakeFailedException
     */
    ...
    private byte[] sha1(String input) throws NoSuchAlgorithmException {
        ...
        return mDigest.digest(input.getBytes());// byte[] result;
    }
