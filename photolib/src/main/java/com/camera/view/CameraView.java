    ...
    private SurfaceHolder.Callback callback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Toast.makeText(getContext(), getResources().getString(R.string.please_check_camera_permission), Toast.LENGTH_SHORT).show();
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width,
                                   int heiupdateCameraOrientationght) {
...
//            String name = "video" + FileOperateUtil.createFileNmae(".3gp");
    ...
    private Bitmap saveThumbnail() throws FileNotFoundException, IOException {
        if (mRecordPath != null) {
            ...
            if (bitmap != null) {
                String mThumbnailFolder = FileOperateUtil.getFolderPath(
                        getContext(), FileOperateUtil.TYPE_THUMBNAIL, "test");
                File folder = new File(mThumbnailFolder);
                if (!folder.exists()) {
                    folder.mkdirs();
                }
                File file = new File(mRecordPath);
                file = new File(folder + File.separator
                        + file.getName().replace("3gp", "jpg"));
                // 存图片小图
    ...
    public void takePicture(PictureCallback callback,
                            CameraContainer.TakePictureListener listener) {
    ...
    private void updateCameraOrientation() {
        try {
            ...
            Log.e(TAG, "updateCameraOrientation: " + e.getLocalizedMessage());
        }
    }
