package com.gzligo.ebizzcardstranslator.badge.impl;
...
import com.gzligo.ebizzcardstranslator.badge.Badger;
import com.gzligo.ebizzcardstranslator.badge.ShortcutBadgeException;
import com.gzligo.ebizzcardstranslator.badge.util.BroadcastHelper;
import com.gzligo.ebizzcardstranslator.badge.util.CloseHelper;
...
public class OPPOHomeBader implements Badger {
    ...
    private static final String INTENT_EXTRA_BADGEUPGRADE_PACKAGE_NAME = "app_badge_packageName";
...
//            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                try {
                    ...
                    bundle.putString(INTENT_EXTRA_BADGEUPGRADE_PACKAGE_NAME, componentName.getPackageName());
