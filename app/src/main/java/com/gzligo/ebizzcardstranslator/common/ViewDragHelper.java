...
public class ViewDragHelper {
    ...
    private static final Interpolator DEFAULT_INTERPOLATION = new Interpolator() {
        @Override
     ...
     */
    private static Interpolator sInterpolator = DEFAULT_INTERPOLATION;


//    /**
//     * Interpolator defining the animation curve for mScroller
//     */
//    private static final Interpolator sInterpolator = new BounceInterpolator();
    ...
    public static ViewDragHelper create(ViewGroup forParent, Callback cb) {
        sInterpolator = DEFAULT_INTERPOLATION;
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        sInterpolator = DEFAULT_INTERPOLATION;
        final ViewDragHelper helper = new ViewDragHelper(forParent.getContext(), forParent, cb);
    ...
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
        ...
        final int duration = computeSettleDuration(mCapturedView, dx, dy, xvel, yvel) + 500;
    ...
    public View findTopChildUnder(int x, int y) {
        ...
        for (int i = childCount - 1; i >= 0; i--) {
            ...
            if (!TextUtils.equals((String) child.getTag(), "undraggable")
