package com.gzligo.ebizzcardstranslator.common.indicator;
...
public class GradualTabView extends View {
    ...
    private int mTextSize = 15;                   //描述文本的默认字体大小 12sp
    ...
    public GradualTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //获取所有的自定义属性
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GradualTabView);
        BitmapDrawable iconNormal = (BitmapDrawable) a.getDrawable(R.styleable.GradualTabView_tabIconNormal);
        if (iconNormal != null) {
            mIconNormal = iconNormal.getBitmap();
        }
        BitmapDrawable iconSelected = (BitmapDrawable) a.getDrawable(R.styleable.GradualTabView_tabIconSelected);
        ...
        mText = a.getString(R.styleable.GradualTabView_tabText);
        mTextSize = a.getDimensionPixelSize(R.styleable.GradualTabView_tabTextSize, mTextSize);
        mTextColorNormal = a.getColor(R.styleable.GradualTabView_textColorNormal, mTextColorNormal);
        mTextColorSelected = a.getColor(R.styleable.GradualTabView_textColorSelected, mTextColorSelected);
        mBadgeBackgroundColor = a.getColor(R.styleable.GradualTabView_badgeBackgroundColor, mBadgeBackgroundColor);
        mPadding = (int) a.getDimension(R.styleable.GradualTabView_paddingTexwithIcon, mPadding);
        a.recycle();
        initText();
    }
