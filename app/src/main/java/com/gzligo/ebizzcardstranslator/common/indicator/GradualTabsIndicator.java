...
public class GradualTabsIndicator extends AutoLinearLayout {

    private ViewPager mViewPager;
    private OnTabChangedListner mListner;
    private List<GradualTabView> mTabViews;
    ...
    public GradualTabsIndicator(Context context) {
        this(context, null);
    }

    public GradualTabsIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradualTabsIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public GradualTabView getCurrentItemView() {
        isInit();
        return mTabViews.get(mCurrentItem);
    }

    public GradualTabView getTabView(int tabIndex) {
        isInit();
    ...
    public void removeAllBadge() {
        isInit();
        for (GradualTabView alphaTabView : mTabViews) {
            alphaTabView.removeShow();
        }
    }

    public void setCurrenTabItem(int tabIndex) {
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCounts; i++) {
            if (getChildAt(i) instanceof GradualTabView) {
                GradualTabView tabView = (GradualTabView) getChildAt(i);
