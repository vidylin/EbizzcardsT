 ...
 *
 */
public class SmoothImageView extends ScaledPhotoView {
	...
	private void initTransform() {
		...
		Log.e(TAG, "initTransform xSScale and ySScale: " + xSScale + "----" + ySScale);
		...
		Log.e(TAG, "initTransform bitmapEndWidth and bitmapEndHeight: " + bitmapEndHeight + "----" + bitmapEndWidth );
